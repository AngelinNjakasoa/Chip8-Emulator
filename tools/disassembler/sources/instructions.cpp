...
/* Opcode 0x00EE -> CLS */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_00E0(const uint16_t opcode) {
  return mnemonic_table[opcode];
}

/* Opcode 00EE -> RET */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_00EE(const uint16_t opcode) {
  return mnemonic_table[opcode];
}

/* Opcode 01nnn -> JP 0xnnn */
/* nnn: address */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_1NNN(const uint16_t opcode) {
  return FormatUnaryOp(mnemonic_table[OP_1NNN], "0x" + GetAddr(opcode));
}

/* Opcode 2nnn -> CALL 0xnnn */
/* nnn: address */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_2NNN(const uint16_t opcode) {
...
/* x: register number */
/* kk: byte */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_3xkk(const uint16_t opcode) {
...
/* x: register number */
/* kk: byte */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_4xkk(const uint16_t opcode) {
  auto operands = GetRegisterImmediate(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_5xy0(const uint16_t opcode) {
...
/* x: register number */
/* kk: byte */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_6xkk(const uint16_t opcode) {
  auto operands = GetRegisterImmediate(opcode);
...
/* x: register number */
/* kk: byte */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_7xkk(const uint16_t opcode) {
  auto operands = GetRegisterImmediate(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_8xy0(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_8xy1(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_8xy2(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_8xy3(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_8xy4(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_8xy5(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_8xy6(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_8xy7(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_8xyE(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* x: register number */
/* y: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_9xy0(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* nnn: address */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_ANNN(const uint16_t opcode) {
...
/* nnn: address */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_BNNN(const uint16_t opcode) {
  std::string operand = GetAddr(opcode);
...
/* x: register number */
/* kk: byte */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Cxkk(const uint16_t opcode) {
  auto operands = GetRegisterImmediate(opcode);
...
/* y: register number */
/* n: nibble */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Dxyn(const uint16_t opcode) {
  auto operands = GetRegisters(opcode);
...
/* Opcode Ex9E -> SKP Vx */
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Ex9E(const uint16_t opcode) {
...
/* Opcode ExA1 -> SKNP Vx */
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_ExA1(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
...
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Fx07(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
...
/* Opcode Fx0A -> LD Vx, K */
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Fx0A(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
...
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Fx15(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
...
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Fx18(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
...
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Fx1E(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
...
/* Opcode Fx29 -> LD F, Vx */
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Fx29(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
...
/* Opcode Fx33 -> LD B, Vx*/
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Fx33(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
...
/* Opcode Fx55 -> LD [I], Vx*/
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Fx55(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
...
/* Opcode Fx65 -> LD Vx, [I] */
/* x: register number */
std::string CPUC8Disassembler::ISIChip8Decoder::INST_Fx65(const uint16_t opcode) {
  std::string operand = GetRegister(opcode);
